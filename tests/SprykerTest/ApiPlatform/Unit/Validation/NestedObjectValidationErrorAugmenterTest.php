...
class NestedObjectValidationErrorAugmenterTest extends Unit
{
    ...
    /**
     * The augmenter only cascades into nested properties typed under the generated
     * `Generated\Api\Storefront` namespace, so both the value-object fixtures and the resource
     * fixtures that reference them must carry that FQCN. They are defined at runtime because the
     * namespace is reserved for generated code and has no source-tree home; keeping them out of the
     * source tree also keeps the resource-property types off static analysis, which would otherwise
     * flag the runtime-only classes as unknown.
     */
    protected function _before(): void
    {
        ...
        $fixtureCode = 'namespace Generated\\Api\\Storefront;'
