...
/**
 * Wires the Storefront API logic tier: providers and processors resolved from the container with
 * only the named collaborators stubbed. No database, no HTTP.
 */
class StorefrontApiLogicHelper extends AbstractApiSuiteHelper
{
    /**
